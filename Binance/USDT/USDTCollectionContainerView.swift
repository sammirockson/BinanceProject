//
//  USDTCollectionContainerView.swift
//  Binance
//
...
class USDTCollectionContainerView: UICollectionViewCell, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let refresh = PullToRefresh.sharedInstance.usdtRefreshControl
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        if (self.motherVC?.isSearching)! {
            ...
            return (self.motherVC?.filteredArray.count)!
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (self.motherVC?.isSearching)! {
            ...
            let obj = self.motherVC?.filteredArray[indexPath.item]
    ...
    func processAndDisplay(object: AnyObject, cell: BaseCollectionViewCell){
        ...
        if let baseAsset = object.object(forKey: "baseAsset") as? String {
            ...
            let seconAttr = NSAttributedString(string: " / USDT", attributes: [NSAttributedStringKey.foregroundColor: RGB.sharedInstance.requiredColor(r: 157, g: 165, b: 178, alpha: 1.0) ,NSAttributedStringKey.font : UIFont(name: FontNames.OpenSansRegular, size: 14) as Any])
