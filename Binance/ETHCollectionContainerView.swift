//
//  ETHCollectionContainerView.swift
//  Binance
//
...
class ETHCollectionContainerView: UICollectionViewCell,  UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let refresh = PullToRefresh.sharedInstance.ethRefreshControl
    ...
    func processAndDisplay(object: AnyObject, cell: BaseCollectionViewCell){
        ...
        if let baseAsset = object.object(forKey: "baseAsset") as? String {
            ...
            let seconAttr = NSAttributedString(string: " / ETH", attributes: [NSAttributedStringKey.foregroundColor: RGB.sharedInstance.requiredColor(r: 157, g: 165, b: 178, alpha: 1.0) ,NSAttributedStringKey.font : UIFont(name: FontNames.OpenSansRegular, size: 14) as Any])
